...
const UI_COPY: Record<LanguageCode, UiCopyTable> = {
  ko: {
    ...
    wordCardClickHint: "단어 카드를 누르면 일기에 바로 들어가요! ✨",
    multilingualHint: "모국어인 {label}로 뜻과 예문을 보여드려요.",
    translatingSuffix: " (번역 중…)",
    exampleHint: "예문 보기",
    todayDiaryTitle: "오늘의 일기",
    diarySubtitle: "오늘 배운 단어로 한 줄 일기를 써보세요!",
    diaryPlaceholder: "오늘의 일기를 적어보세요... 🌸",
    aiReadingTitle: "AI 선생님이 읽고 있어요...",
    aiReadingWait: "잠시만 기다려 주세요 ✨",
    aiChecking: "AI 선생님이 검사 중...",
    aiCheckButton: "AI 선생님에게 검사받기",
    minCharsHint: "조금만 더 써볼까요? (5글자 이상)",
    footerMessage: "매일 조금씩, 한국어가 쑥쑥 늘어요!",
  ...
  vi: {
    ...
    wordCardClickHint: "Nhấn thẻ từ để thêm vào nhật ký! ✨",
    multilingualHint: "Hiển thị nghĩa và ví dụ bằng {label}.",
    translatingSuffix: " (đang dịch…)",
    exampleHint: "Xem ví dụ",
    todayDiaryTitle: "Nhật ký hôm nay",
    diarySubtitle: "Viết một dòng nhật ký với từ vừa học hôm nay!",
    diaryPlaceholder: "Viết nhật ký hôm nay ở đây... 🌸",
  ...
  en: {
    ...
    exampleHint: "View example",
    todayDiaryTitle: "Today's diary",
    diarySubtitle: "Write a one-line diary using today's words!",
    diaryPlaceholder: "Write today's diary here... 🌸",
    aiReadingTitle: "AI teacher is reading...",
    aiReadingWait: "Please wait a moment ✨",
    aiChecking: "AI teacher is checking...",
    aiCheckButton: "Ask the AI teacher to check",
    minCharsHint: "Write a little more? (at least 5 characters)",
    footerMessage: "A little every day, your Korean grows!",
